...
private UserService userService;
    ...
    public String index(Model model, Principal principal) {
        ...
        model.addAttribute("female", renterService.countFemale(userService.findByUsername(principal.getName())));
        model.addAttribute("male", renterService.countMale(userService.findByUsername(principal.getName())));
        model.addAttribute("totalRenters", renterService.totalRenter(userService.findByUsername(principal.getName())));
